 ...
 *
 *   $Log: gxgif.c,v $
 *   Revision 1.10  2011/10/01 23:32:11  dasilva
 *   ams: replaced with version from cola grads v2.0.0
 *
...
#include <stdlib.h>
/*  #include "gd.h" */
static char rcsid[] = "$Id: gxgif.c,v 1.10 2011/10/01 23:32:11 dasilva Exp $";
     ...
     for (i=1;i<argc;i++) {
       if (*(argv[i])=='-') {  /* parse options */
	     ...
	     sscanf(argv[++i],"%d",&(o->sy));break;
	       ...
	       o->verbose = 1;
	       printf("This is gxgif $Revision: 1.10 $, $Date: 2011/10/01 23:32:11 $\n");
	   }
           else { 
